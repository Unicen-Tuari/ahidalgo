...
function creadores(){
    ...
    <body>
        ...
        <div class="fondo-creadores">
            <h1>CREADORES</h1>
            <p class="texto-gral">Boku No Hero Academia no sería posible sin el duro esfuerzo
                 del mangaka Kohei Horikoshi, mientras que la adaptación al anime fue desde sus
                  comienzos la responsabilidad de Studio Bones. Prepárate para aprender más sobre
                   los que hacen posible este maravilloso proyecto.
            </p>
            <h2>Kohei Horikoshi</h2>
            <p class="texto-creadores">
                <img src="./img/mangaka1.jpg" alt="Kohei Horikoshi" class="foto1">
            ...
            <h2>Studio Bones</h2>
                <p class="texto-creadores">
                    <img src="./img/estudio1.jpg" alt="Estudio Bones" class="foto2">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
                exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure 
                dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
